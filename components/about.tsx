...
export default function About() {
  return (
    <section id="about" className="bg-[#F5F5F5] py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&q=80"
              alt="Iqbal Food restaurant ambiance"
              fill
          ...
          <div>
            <span className="inline-block rounded-full bg-red-50 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-primary mb-4">
              Our Story
            </span>

            <h2 className="text-3xl sm:text-4xl font-bold text-secondary leading-tight mb-6 text-balance">
              Where Quality Meets
              <br />
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Iqbal Food was born from a simple belief: fast food should never
              ...
              <p>
                ...
                families sharing a meal to friends catching up over fries, Iqbal
                Food is where great food brings people together.
              </p>
            </div>
